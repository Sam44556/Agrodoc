 ...
 */
router.put("/", farmerOnlyRoute, async (req, res) => {
    try {
        const userId = req.user.id;
        const { 
        // Notification settings
        emailNotifications, pushNotifications, smsNotifications, marketAlerts, orderUpdates, chatMessages, weeklyReports, 
        // Privacy settings
        profileVisibility, showContactInfo, showLocation, allowDirectMessages, dataCollectionConsent, 
        // App settings
        language, timezone, currency, theme, 
        // Security settings
        twoFactorEnabled, loginNotifications, sessionTimeout } = req.body;
 ...
 */
router.patch("/password", farmerOnlyRoute, async (req, res) => {
    try {
        const userId = req.user.id;
 ...
 */
router.delete("/account", farmerOnlyRoute, async (req, res) => {
    try {
        const userId = req.user.id;
