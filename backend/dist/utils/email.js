...
export const sendVerificationEmail = async ({ to, subject, verificationUrl, userName = 'there' }) => {
    try {
...
export const sendResetPasswordEmail = async ({ to, subject, resetUrl, userName = 'there' }) => {
    try {
        const { data, error } = await resend.emails.send({
    ...
    try {
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <p style="color: #666; line-height: 1.6; margin-bottom: 25px;">
            ...
            ${roleMessages[userRole] || 'Welcome to the AgroTech community!'}
          </p>
